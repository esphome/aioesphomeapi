...
class TestStateLogProxy:
    """Tests for _StateLogProxy."""

    def test_forwards_log_messages(self) -> None:
    ...
    def test_not_seen_verbose_initially(self) -> None:
        proxy = _StateLogProxy(lambda _: None)
        assert proxy.seen_verbose is False

    def test_detects_verbose_level(self) -> None:
        proxy = _StateLogProxy(lambda _: None)
        msg = SubscribeLogsResponse()
    ...
    def test_detects_very_verbose_level(self) -> None:
        proxy = _StateLogProxy(lambda _: None)
        msg = SubscribeLogsResponse()
    ...
    def test_does_not_trigger_on_debug(self) -> None:
        proxy = _StateLogProxy(lambda _: None)
        msg = SubscribeLogsResponse()
        msg.level = LogLevel.LOG_LEVEL_DEBUG
        proxy.on_log(msg)
    ...
    def test_does_not_trigger_on_info(self) -> None:
        proxy = _StateLogProxy(lambda _: None)
        msg = SubscribeLogsResponse()
...
class TestSubscribeEntityStates:
    """Tests for _subscribe_entity_states."""

    async def test_skips_initial_state(self) -> None:
    ...
    async def test_emits_synthetic_log_with_ansi_color(self) -> None:
    ...
    async def test_suppresses_after_verbose_detected(self) -> None:
    ...
    async def test_different_device_ids_tracked_separately(self) -> None:
