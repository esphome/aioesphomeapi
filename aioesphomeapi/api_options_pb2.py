...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(fixed_array_size)
  google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(no_zero_copy)
  google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(fixed_array_skip_zero)
  google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(fixed_array_size_define)
  google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(fixed_array_with_length_define)
  google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(pointer_to_buffer)
  google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(container_pointer)
  google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(fixed_vector)
  google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(container_pointer_no_template)
