...
_SENSORSTATECLASS = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='STATE_CLASS_TOTAL', index=2, number=2,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='STATE_CLASS_TOTAL_INCREASING', index=3, number=3,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
