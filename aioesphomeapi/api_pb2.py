...
_HELLOREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='client_version', full_name='HelloRequest.client_version', index=1,
