...
_CLIMATESTATERESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fan', full_name='ClimateStateResponse.fan', index=8,
...
_CLIMATESTATERESPONSE.fields_by_name['fan'].enum_type = _CLIMATEFANMODE
